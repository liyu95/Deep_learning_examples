...
def train():
    ...
    t_target_image_224 = tf.image.resize_images(t_target_image, 
        size=[224, 224], method=0, align_corners=False) 
        # resize_target_image_for_vgg # http://tensorlayer.readthedocs.io/en/latest/_modules/tensorlayer/layers.html#UpSampling2dLayer
    t_predict_image_224 = tf.image.resize_images(net_g.outputs, 
        size=[224, 224], method=0, align_corners=False) # resize_generate_image_for_vgg
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=str, default='srgan', help='srgan, evaluate, use')
    parser.add_argument('--path', type=str,  help='the path to the low resolution image')
